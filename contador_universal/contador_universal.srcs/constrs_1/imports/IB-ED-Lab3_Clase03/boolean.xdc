...
#set_property -dict {PACKAGE_PIN J5 IOSTANDARD LVCMOS33} [get_ports {hab_cont_boton[1]}]
...
#set_property -dict {PACKAGE_PIN A6 IOSTANDARD LVCMOS33} [get_ports {display[7]}]
